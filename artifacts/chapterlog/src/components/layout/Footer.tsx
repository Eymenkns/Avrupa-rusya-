      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pt-14 pb-10">
          <div className="lg:col-span-1">
            ...
            <p className="text-white/35 text-sm leading-relaxed mb-5 font-serif whitespace-pre-line">{t.footer.tagline}</p>
          </div>

          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/30 mb-5 font-sans">{t.footer.quickLinks}</h4>
            ...
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/30 mt-6 mb-3 font-sans">{t.footer.popularGuides}</h4>
            <ul className="space-y-2">
              {t.footer.popularGuideLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-white/30 hover:text-accent transition-colors flex items-center gap-2 text-xs font-sans group">
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/30 mb-5 font-sans">{t.footer.ourServices}</h4>
            <ul className="space-y-2.5">
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/30 mb-5 font-sans">{t.footer.contactInfo}</h4>
        ...
        <div className="py-6 border-t border-white/6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/20 text-xs font-sans text-center md:text-left">
            {t.footer.copyright}
          </p>
          <div className="flex gap-5 text-xs text-white/20 font-sans flex-wrap justify-center">
            <a href="#" className="hover:text-white/45 transition-colors">{t.footer.terms}</a>
            <a href="#" className="hover:text-white/45 transition-colors">{t.footer.privacy}</a>
            <span>{t.footer.masakBadge}</span>
          </div>
        </div>
      </div>
    </footer>
